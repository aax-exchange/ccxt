...
class aax(Exchange):
    ...
    async def cancel_all_orders(self, symbol=None, params={}):
        ...
        response = None
        if isSpot:
            response = await self.privateDeleteSpotOrdersCancelAll(self.extend(request, params))
        else:
            response = await self.privateDeleteFuturesOrdersCancelAll(self.extend(request, params))
    ...
    async def cancel_order(self, id, symbol=None, params={}):
        ...
        # spot or future
        try:
            response = await self.privateDeleteSpotOrdersCancelOrderID(request)
        except Exception as error:
            response = await self.privateDeleteFuturesOrdersCancelOrderID(request)
    ...
    async def create_order(self, symbol, type, side, amount, price=None, params={}):
        ...
        if isSpot:
            ...
            response = await self.privatePostFuturesOrders(self.extend(request, params))
        if response and response['code'] != 1:
            raise BadResponse(response['message'])
        # response={
        #     "code":1,
    ...
    async def edit_order(self, id, symbol, type, side, amount, price=None, params={}):
        await self.cancel_order(id, symbol, params)
    ...
    async def fetch_balance(self, params={}):
        ...
        response = await self.privateGetAccountBalances({'purseType': purseType[type]})
        # response = {
        #     'code': 1,
        #     'message': 'success',
        #     'ts': 1603187218565,
    ...
    async def fetch_my_trades(self, symbol=None, since=None, limit=None, params={}):
        ...
        response = None
        if optionType == 'spot':
            response = await self.privateGetSpotTrades(self.extend(request, params))
        else:
            response = await self.privateGetFuturesTrades(self.extend(request, params))
        if response and response['code'] != 1:
            raise BadResponse(response['message'])
        # response={
        #     "code":1,
    ...
    async def fetch_ohlcv(self, symbol, timeframe='1m', since=None, limit=None, params={}):
        ...
        response = await self.publicGetGetHistMarketData(self.extend(request, params))
    ...
    async def fetch_open_orders(self, symbol=None, since=None, limit=None, params={}):
        ...
        if isSpot:
            ...
            response = await self.privateGetFuturesOpenOrders(self.extend(request, params))
        # response={
        #     "code":1,
        #     "data":{
        #        "list":[
    ...
    async def fetch_order(self, id=None, symbol=None, params={}):
        ...
        if isSpot:
            ...
            response = await self.privateGetFuturesOrders(self.extend(request, params))
        # response={
        #     "code":1,
        #     "data":{
        #        "total":19,
    ...
    async def fetch_order_book(self, symbol, limit=None, params={}):
        ...
        orderbook = await self.publicGetMarketOrderbook(self.extend(request, params))
    ...
    async def fetch_ticker(self, symbol, params={}):
        ...
        market = self.market(symbol)
        value = market['id']
        response = await self.publicGetMarketTickers()
